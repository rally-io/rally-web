...
const payload = (generatedAt: string, matches = 12): GlobeGraph => ({
  ...
  nodes: [
    {
      id: 'p1', name: 'Omer Levi', avatarUrl: null, avatarCleanUrl: null, portraitUrl: null, gender: null, skillLevel: 4, skillTier: 'silver',
      levelVerified: false, levelReliability: null, club: null, matches, winRate: 50, since: 2024,
    },
    {
      id: 'p2', name: 'Dani Shoval', avatarUrl: null, avatarCleanUrl: null, portraitUrl: null, gender: null, skillLevel: 3, skillTier: 'bronze',
