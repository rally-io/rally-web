...
export interface PlayerGlobeProps {
  ...
  background?: string
  /** the signed-in player — their node wears the "you" marker */
...
export const PlayerGlobe = forwardRef<PlayerGlobeHandle, PlayerGlobeProps>(function PlayerGlobe(
  { graph, index, background = DEFAULT_BACKGROUND, viewerId, viewerLabel, showRivals, spinning, className, onSelect, onHover, onBackgroundClick },
  ref,
) {
