...
it('reports a failed send instead of asking for a code that was not sent', async () => {
  vi.mocked(api.requestPhoneVerificationOtp).mockResolvedValue({ success: false, error: { message: 'Try again later' } } as any)
  render(<Form />)
